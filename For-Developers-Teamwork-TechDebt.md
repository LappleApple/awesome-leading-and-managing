...
- [Keep a Changelog](http://keepachangelog.com/en/1.0.0/) - by Olivier Lacan. Takeaway: An entire website dedicated to the art of the changelog, with an FAQ and an aim to produce a better changelog convention.

- [Lead Developer Career Guide](https://www.manning.com/books/lead-developer-career-guide) - by Shelley Benhoff. Learn the skills you need to be a lead developer, with expert advice on mentoring teams, handling clients and project managers, and keeping your head in emergencies.
